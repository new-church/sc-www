...
[copyright.org.au](https://www.copyright.org.au/resources) - the Australian Copyright Council (ACC) have plenty of resources and info on their website to answer questions about copyright laws in Australia.
...
Apart from websites with collections of free existing photos (see sample list below), there are also many free Artificial Intelligence (AI) image creation engines out there, which generate an image based on your description of what you would like to see (also see list below). Because the image is generated by a machine, it is totally unique and are not protected under copyright laws, so can be freely used. To generate an image, state your image requirements in normal, everyday English, e.g. "create an image of a penguin in a red suit doing a dance on the equator in the style of Van Gogh." There are many other free or paid services out there, or sites with collections of existing pictures which are free to use. Try the sites below, then download the image you want for your work.

Collections of existing free images
-----------------------------------
...
[unsplash.com](https://unsplash.com/s/photos/free-images)
Features beautiful, free images and photos that you can download and use for any project. No attribution is required, and the images are free for commercial use. 

[pixabay.com](https://pixabay.com/images/search/free%20images)
Offers over 5.2 million high-quality stock images, videos, and music shared by a talented community. All content is released under the Pixabay License, making it safe to use without asking for permission or giving credit to the artist, even for commercial purposes. 

[stocksnap.io](https://stocksnap.io)
Provides a large selection of high-resolution images that are free from copyright restrictions. You can use them for personal or commercial projects without attribution. 

[pikwizard.com](https://pikwizard.com/photo)
Offers a stunning library of over 1 million stock images and videos. The content is royalty-free and safe for commercial use, with no attribution required. Avoid the images labelled "premium" to find the free images.
...
Generates four images to choose from every time.

[canva.com](https://www.canva.com/free)
Particularly good for design of logos, social media posts, and other visual content for people who have no prior design experience. 

[leonardo.ai](https://leonardo.ai/ai-art-generator)
Offers a generous free tier, enabling users to generate up to 150 images per month. It provides granular control over image generation, making it suitable for users who desire detailed customisation.

[fotor.com](https://www.fotor.com/images/create)
Offers a versatile range of editing tools.

[creator.nightcafe.studio](https://creator.nightcafe.studio)
Has a strong community and a user-friendly interface. Allows users to generate AI art and share it within the platform. Supports various styles and offers daily free credits for image generation.

[ideogram.ai](https://docs.ideogram.ai)
Freemium image creation (freemium means that some of the features and services are free, but to use more or better features needs a user to pay a premium). This product excels in generating legible text within images, a feature where many AI models fall short. It's particularly useful for creating images that incorporate textual elements seamlessly.